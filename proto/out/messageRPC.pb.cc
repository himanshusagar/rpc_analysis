...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_messageRPC_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_messageRPC_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_messageRPC_2eproto = nullptr;

const uint32_t TableStruct_messageRPC_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_messageRPC_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\020messageRPC.proto\"\034\n\014HelloRequest\022\014\n\004na"
  "me\030\001 \001(\t\"\035\n\nHelloReply\022\017\n\007message\030\001 \001(\t2"
  "3\n\007Greeter\022(\n\010SayHello\022\r.HelloRequest\032\013."
  "HelloReply\"\000b\006proto3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_messageRPC_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_messageRPC_2eproto = {
  false, false, 140, descriptor_table_protodef_messageRPC_2eproto, "messageRPC.proto", 
  &descriptor_table_messageRPC_2eproto_once, nullptr, 0, 2,
  schemas, file_default_instances, TableStruct_messageRPC_2eproto::offsets,
  file_level_metadata_messageRPC_2eproto, file_level_enum_descriptors_messageRPC_2eproto, file_level_service_descriptors_messageRPC_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_messageRPC_2eproto_getter() {
  return &descriptor_table_messageRPC_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_messageRPC_2eproto(&descriptor_table_messageRPC_2eproto);
...
::PROTOBUF_NAMESPACE_ID::Metadata HelloRequest::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_messageRPC_2eproto_getter, &descriptor_table_messageRPC_2eproto_once,
      file_level_metadata_messageRPC_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata HelloReply::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_messageRPC_2eproto_getter, &descriptor_table_messageRPC_2eproto_once,
      file_level_metadata_messageRPC_2eproto[1]);
}
